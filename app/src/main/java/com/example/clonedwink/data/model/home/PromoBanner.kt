 ...
 * [com.example.clonedwink.data.model.CarouselSlide.imageUrl] is — a real backend can supply a
 * photo later; until then ui/home/HomeSections.kt falls back to a brand-gradient card carrying
 * just the title/subtitle text.
 */
