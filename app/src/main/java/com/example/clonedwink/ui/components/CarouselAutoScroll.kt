 ...
 * last one. Shared by the landing screen's onboarding carousel and the home screen's promo
 * banner carousel — both wanted identical auto-scroll behavior, just at different intervals.
 *
 ...
 * `ui/landing/LandingScreen.kt`'s `SlideCarousel` or `ui/home/HomeSections.kt`'s
 * `PromoBannerCarousel` for example call sites).
 *
