...
// reference screenshot, rather than two near-duplicate classes — feature/home's
// HomeComponents.kt's PlaceCardView renders whichever optional fields are non-null. All the
// price/rating/status text below is pre-formatted (e.g. "$15.00", "4.2", "Open now") rather than
// raw numbers, since this mock data layer stands in for what would otherwise be a server
// response already formatted for display — see DefaultHomeRepository.kt's file comment for why
// these particular strings live as Kotlin literals instead of in strings.xml.
/**
