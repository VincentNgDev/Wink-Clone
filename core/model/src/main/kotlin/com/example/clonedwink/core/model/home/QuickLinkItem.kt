...
// keeping Compose UI types out of the Model layer is what lets feature/home's
// HomeComponents.kt's `quickLinkIconFor(id)` decide the icon, the same "id picks the icon in the
// View layer" split LandingScreen's `iconForSlide(id)` already established for carousel slides.
/**
