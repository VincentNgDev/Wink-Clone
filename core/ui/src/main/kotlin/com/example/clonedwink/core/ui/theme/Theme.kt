package com.example.clonedwink.core.ui.theme
...
import com.example.clonedwink.core.ui.R
...
// core/ui/build.gradle.kts) rewrites it so it can be re-invoked ("recomposed") automatically
...
// hardcoding hex values inline. It lives in `core:ui` (not any one feature module) because both
// feature:landing and feature:home wrap their screens in it.
@Composable
