...
// Android/Kotlin: `feature/home/ui/HomeSections.kt`'s PlaceCardRow, FeatureCardRow, and
// MediaCardRow — plus HomeScreen.kt's partner row, before this change — were four near-identical
// copies of "a SectionHeader, a fixed gap, then a LazyRow with the same content padding and
// spacedBy arrangement." This is that shape pulled out once; each of those four now just
// describes what its *own* card looks like and hands it to this function as the `item` lambda.
 ...
 *
 * @param T the type of each row entry — a plain data class like [com.example.clonedwink.core.model.home.PlaceCard],
